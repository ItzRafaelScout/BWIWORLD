...
function setup() {
    $("#chat_send").click(sendInput),
		...
		socket.on("loremipsum", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.runSingleEvent(b.data.event_list_loremipsum);
        }),
        ...
        socket.on("mod", function () {
		    mod = true;
	    }),
        socket.on("admin", function () {
		    admin = true;
	    }),
        socket.on("developer", function () {
		    developer = true;
	    }),
        ...
        return (
            _createClass(a, [
                ...
                },
				{
                    key: "loremipsum",
                    value: function () {
                        this.runSingleEvent(this.data.event_list_loremipsum);
                    },
                },
                {
                    key: "fact",
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_loremipsum = [
        {
            type: "text",
            text:
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ut tellus accumsan ipsum feugiat pretium. Aliquam lorem erat, mollis et purus at, egestas viverra eros. Donec sed convallis neque. Nunc placerat pretium dui, ut semper elit molestie ac. Ut sollicitudin rhoncus ex vitae convallis. Pellentesque luctus est nunc, id tristique dolor semper non. Etiam sodales elit et sollicitudin finibus. Vivamus vestibulum, augue non mollis rhoncus, ligula magna blandit tortor, non rutrum nunc lorem ac orci. Ut sagittis, erat sed congue accumsan, nulla risus porta purus, sed luctus enim ex sit amet sapien. Ut semper eget dui vel auctor. Donec ultrices maximus ligula, et auctor dui porttitor sit amet. Aliquam malesuada blandit eros, a aliquam dui molestie sed. Vestibulum varius risus sit amet posuere tempus. Aenean ultricies dui a libero vulputate, vel maximus odio condimentum. Sed nec quam neque.",
        },
		{
            type: "text",
            text:
                "Integer volutpat iaculis mattis. Suspendisse a metus neque. Donec varius fringilla suscipit. Praesent sollicitudin elit a ullamcorper gravida. Cras libero tellus, sagittis ac odio eu, interdum fringilla orci. Phasellus faucibus tellus vitae ante congue fringilla. In eu ultrices tortor.",
        },
		{
            type: "text",
            text:
                "Integer id tincidunt magna. Vivamus iaculis fringilla felis, eget hendrerit quam rutrum ut. Curabitur sed quam tortor. Praesent porttitor, lorem sed condimentum interdum, odio tortor scelerisque justo, id aliquet diam felis scelerisque ante. Nulla accumsan feugiat ipsum, id vehicula massa pharetra id. Etiam in magna euismod, porttitor nunc vel, imperdiet ex. Nam nisl magna, eleifend ut ligula eu, volutpat varius mauris.",
        },
		{
            type: "text",
            text:
                "Etiam fermentum efficitur diam, sed cursus nibh molestie eget. Vestibulum a cursus ipsum. Morbi lobortis vulputate eros sed blandit. Vivamus sit amet nisl maximus, imperdiet nisi ac, luctus leo. Aenean nec tincidunt arcu. Suspendisse sodales tempor mattis. In sollicitudin lectus a ipsum lobortis, id varius enim suscipit. Donec lobortis ligula sit amet tellus commodo, eu suscipit odio convallis. Vestibulum viverra justo eget aliquet fermentum. Vivamus metus ligula, rutrum et molestie at, vestibulum non nunc. Nullam posuere augue in urna pulvinar scelerisque. Praesent tristique egestas porta. Fusce eu dolor et lacus aliquam volutpat eu vitae urna. Morbi at volutpat nulla, congue ultrices sapien. Donec dignissim iaculis convallis.",
        },
		{
            type: "text",
            text:
                "Vestibulum in mattis neque, non malesuada augue. Duis in dui risus. Phasellus mauris mauris, auctor nec aliquet sed, consectetur eu ex. Suspendisse et pulvinar turpis, porttitor pulvinar sem. Mauris lobortis auctor erat at pellentesque. Duis vel urna ultrices est lobortis consectetur id vel libero. Donec eget mi gravida, ornare orci vel, gravida ex. Morbi at volutpat enim.",
        },
    ]),
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope", "reddie", "weegee", "orange", "cyan"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziCyan", "BonziOrange", "topjej"];
